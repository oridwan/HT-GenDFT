...
def main():
    ...
    parser.add_argument('--compositions', default='quaternary_boron_hydride_compositions.json',
                        help='Path to compositions JSON file')
    parser.add_argument('--output-dir', default='../../results/quaternary_boron_hydride',
                        help='Path to results directory')
    parser.add_argument('--failed-file', default='../../results/quaternary_boron_hydride/failed_compositions.txt',

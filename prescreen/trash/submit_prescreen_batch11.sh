...
#SBATCH --output=prescreen_batch11_%j.out
#SBATCH --error=prescreen_batch11_%j.err
...
echo "========================================"
echo "Prescreen batch $BATCH_ID on partition Nebula_GPU"

...
Examples:
  python3 to_cif.py --db prescreening_structures_batch14.db --output-dir ./batch14_cif
  python3 to_cif.py --db prescreening_structures_batch14.db Ba2N_s001 Ba2N_s010
"""

...
Examples:
  python3 test/to_cif.py --db prescreening_structures_batch14.db --output-dir ./batch14_cif
  python3 test/to_cif.py --db prescreening_structures_batch14.db Ba2N_s001 Ba2N_s010
"""
...
def export_db_to_cif(db_path, output_dir, structure_ids=None, overwrite=False):
    """
